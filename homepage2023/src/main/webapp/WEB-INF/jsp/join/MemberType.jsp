...
<div class="confirm-area user-area">
	<article>
		...
		<div class="confirm_box">
			<p class="mB20">일반회원</p>
			<div class="btn-cont"><a class="btn spot member-type" href="/join/memberRegist.do?loginType=normal" ><span>회원가입</span></a></div>
		</div>
	</article>
	...
	<article>
		...
		<div class="confirm_box">
			...
			<div class="btn-cont"><a class="btn-kakao" href="#" data-type="join">
